...
function Minute({minute,handleDownload,handleDelete,user,handleEdit}){
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={2}>
              <Grid item xs>
                ...
                <span>
                  <Tooltip title='Edit'>
                    <IconButton aria-label="edit" onClick={() => handleEdit(minute)}>
    ...
    <Grid container>
      ...
      <Grid item xs={12} style={{marginTop:'80px'}}>
        <Grid container justify="center" alignItems="center">
          <Typography variant='h5'>REGULAR MEETINGS<hr style={{width:'15%'}} /></Typography>
        </Grid>
      </Grid>
